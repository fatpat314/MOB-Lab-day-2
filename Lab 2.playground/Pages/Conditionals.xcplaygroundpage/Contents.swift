...
let responseOne = stringToEmoji(word: "happy")
let responseTwo = stringToEmojis(word: "laughing")
let responseThree = stringToEmojis(word: "cool")
let responseFour = stringToEmojis(word: "meh")

print(responseOne, responseTwo, responseThree, responseFour)
...
*/
func stringToEmojisPrima(word:String) -> Character{
...
let response = stringToEmojisPrima(word: "happy")
let responseUn = stringToEmojisPrima(word: "laughing")
let responseDu = stringToEmojisPrima(word: "cool")
let responseTwah = stringToEmojisPrima(word: "I dont speak French")

print(response, responseUn, responseDu, responseTwah)
